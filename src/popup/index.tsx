...
class Timer {
  ...
  setTimer(state) {
    ...
    if (state.endTime != null) {
      ...
      estimate = periodToTime(endTimeToPeriod(state.endTime))
    } else if (state.restMs != null) {
      // pause and resume popup
      estimate = periodToTime(state.restMs)
    } else if (state.totalMs != null) {
      // reset
      estimate = periodToTime(state.totalMs)
    }
  ...
  updateTimer() {
    ...
    let updateHelper = () => {
      ...
      let timeObject = periodToTime(currentDiff)
